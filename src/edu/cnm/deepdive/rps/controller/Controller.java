...
public class Controller {
  ...
  @FXML
  private ScrollPane view_scroller;
  @FXML
  ...
  private void fitView(ActionEvent actionEvent) {
    if(fitCheckbox.isSelected()){
      terrainView.setWidth(view_scroller.getWidth()-2);
      terrainView.setHeight(view_scroller.getHeight()-2);
  ...
  public void stop(ActionEvent actionEvent) {
    running = false;
    //todo: investigate whether the thread should reenable the buttons when it is done
